...
const readerProfiles = {
  comment_20260503:{
    story:'05.03，两个人在评论区发生了一段公开互动。这里把互动发生的日期记下来，母帖里的影像什么时候拍摄则先留白。',
    note:'能确认：互动发生于 05.03。暂不确认：母帖影像的实际拍摄日。',
    quote:'“互动发生在这一天”，不等于“照片也拍在这一天”。'
  },
...
function readerProfile(e){
  ...
  return {
    story:custom.story||e.left_intro||e.reading_logic||'',
    note:custom.note||readerEssentialNote(e),
    quote:custom.quote||e.left_note||''
  };
}
